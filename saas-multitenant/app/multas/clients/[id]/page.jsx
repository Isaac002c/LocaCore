                      ...
                      <tbody>
                        {contracts.map((contract) => (
                            ...
                            <td>
                              <div className="actions-cell">
                                <button
                                  ...
                                  className="btn-icon"
                                  title="Protocolo"
                                  style={{ color: contract.protocol_number ? 'var(--nx-primary)' : undefined }}
                                >
                                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                                    <polyline points="14 2 14 8 20 8"/>
                          ...
                          {expandedProtocol === contract.id && (
                            <tr>
                              <td colSpan="99" style={{ padding: 0, background: 'rgba(165, 107, 255, 0.03)' }}>
                                <ProtocolPanel
                                  contract={contract}
            ...
            {clientDocs.map((doc) => (
              <div key={doc.id} className="cd-doc-item">
                ...
                <div className="cd-doc-info">
                  {doc.file_url
                    ? <a href={doc.file_url} target="_blank" rel="noreferrer" className="cd-doc-name" style={{ color: 'var(--nx-primary)', textDecoration: 'none' }}>{doc.file_name || doc.name || 'Documento'}</a>
