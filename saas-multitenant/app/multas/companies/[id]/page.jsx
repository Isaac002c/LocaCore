                ...
                <tr key={v.id} style={v.status === 'inativo' ? { opacity: 0.55 } : undefined}>
                  <td>
                    <button onClick={() => goToVehicle(v.id)} title="Abrir veículo"
                      style={{ fontFamily: 'monospace', fontWeight: 700, color: 'var(--nx-primary)', background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontSize: 14, textDecoration: 'underline' }}>
                      {v.plate || '—'}
                    </button>
                  </td>
